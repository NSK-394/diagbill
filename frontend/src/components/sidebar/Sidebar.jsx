...
import {
  ...
  FlaskConical, Building2, LogOut, Plus, ChevronRight, KeyRound
} from 'lucide-react';
    ...
    <>
      <div className="flex flex-col h-full bg-slate-800 text-white">
        ...
        <div className="px-4 pb-5 border-t border-slate-700 pt-4">
          <div className="flex items-center gap-3 px-3 py-2 rounded-xl bg-slate-700/50 mb-2">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 text-sm text-slate-400 hover:text-blue-400 hover:bg-blue-500/10 rounded-xl transition-colors duration-200 mb-1"
          >
            <KeyRound size={16} />
            Change Password
          </button>
